                    ...
                    <ul id="menu-main-menu" class="nav navbar-nav">
                        ...
                        <li class="menu-item menu-item-has-children dropdown nav-item">
                            ...
                            <ul class="dropdown-menu">
                                <li class="menu-item nav-item"><a href="<?php echo e(url('/' . $locale . '/services/general-cleaning')); ?>" class="dropdown-item"><span><?php echo e(__('home.service_general')); ?></span></a></li>
                                <li class="menu-item nav-item"><a href="<?php echo e(url('/' . $locale . '/services/deep-cleaning')); ?>" class="dropdown-item"><span><?php echo e(__('home.service_deep')); ?></span></a></li>
                                <li class="menu-item nav-item"><a href="<?php echo e(url('/' . $locale . '/services/move-in-out')); ?>" class="dropdown-item"><span><?php echo e(__('home.service_move')); ?></span></a></li>
                                <li class="menu-item nav-item"><a href="<?php echo e(url('/' . $locale . '/services/office-cleaning')); ?>" class="dropdown-item"><span><?php echo e(__('home.service_office')); ?></span></a></li>
                                <li class="menu-item nav-item"><a href="<?php echo e(url('/' . $locale . '/services/window-cleaning')); ?>" class="dropdown-item"><span><?php echo e(__('home.service_window')); ?></span></a></li>
                                <li class="menu-item nav-item"><a href="<?php echo e(url('/' . $locale . '/services/carpet-cleaning')); ?>" class="dropdown-item"><span><?php echo e(__('home.service_carpet')); ?></span></a></li>
                            </ul>
                        </li>
