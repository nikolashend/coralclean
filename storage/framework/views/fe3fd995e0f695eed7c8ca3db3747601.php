...
span.menu-service { background: #2ec4c6; color: #fff; }
span.menu-service a { color: #fff !important; text-decoration: none; }
span.menu-service:hover, span.menu-service.menuactive { background: #ff6f61; }
span.menu-service:hover a, span.menu-service.menuactive a { color: #fff !important; }
...
/* ============================================================
   NEW: Package Cards (premium style)
   ============================================================ */
.package-card {
...
.package-card__image {
    ...
    background: linear-gradient(135deg, #2ec4c6, #ff6f61);
}
...
/* ============================================================
   NEW: Floating Action Buttons (WhatsApp + Call)
   ============================================================ */
.floating-buttons {
...
.contact-panel-close:hover { color: #ff6f61; }
...
/* ============================================================
   Desktop: Contact button in navbar
   ============================================================ */
.navbar-contact-btn { display: inline-block; margin-right: 15px; }
.btn-contact-header {
...
.btn-contact-header:hover {
    background: #fff !important; color: #ff6f61 !important;
    border: 2px solid #ff6f61;
}

/* ============================================================
   Service card links - no underline on hover
   ============================================================ */
.service-card-link:hover { text-decoration: none !important; color: inherit !important; }
...
@media (max-width: 576px) {
    ...
    .service-card-price { font-size: 14px; padding: 5px 16px; }
}
</style>
