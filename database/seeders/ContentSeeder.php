            ...
            [
                ...
                'translations' => [
                    'ru' => [
                        ...
                        'text1' => 'Уборка дома — это задача, которая отнимает много времени и сил, особенно в современном ритме жизни. CoralClean предлагает услугу регулярной и генеральной уборки квартир и домов в Таллинне и Харьюмаа. Мы работаем аккуратно, спокойно и по понятному чек-листу.',
            ...
            [
                ...
                'translations' => [
                    'ru' => [
                        ...
                        'image_path' => 'coralclean/services/home clean.png',
                        'text1' => 'Генеральная уборка — это не просто "помыть полы". Это комплексная глубокая очистка каждого помещения: кухня, санузлы, плинтусы, труднодоступные углы, техника. CoralClean выполняет генеральную уборку квартир, домов и офисов в Таллинне.',
            ...
            [
                ...
                'translations' => [
                    'ru' => [
                        ...
                        'text1' => 'Чистый офис — это не только комфорт, но и продуктивность сотрудников. CoralClean предлагает услугу регулярной уборки офисных и коммерческих помещений в Таллинне.',
