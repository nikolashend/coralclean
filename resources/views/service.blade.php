...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="text-center wow fadeInUp" data-wow-delay="0.6s">
                            ...
                            <a href="{{ $contact->messenger ?? 'https://m.me/coralclean.ee' }}" target="_blank" class="custom-button" style="background: #0084FF; margin-left: 10px;">Messenger →</a>
                        </div>
    ...
    <div class="floating-buttons">
        ...
        <a href="{{ $contact->messenger ?? 'https://m.me/coralclean.ee' }}" target="_blank" class="floating-btn floating-btn--messenger" aria-label="Messenger">
