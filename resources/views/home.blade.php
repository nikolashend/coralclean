...
<body>
    ...
    <section class="cta-section">
        <div class="container">
            ...
            <div class="wow fadeInUp" data-wow-delay="0.5s">
                ...
                <a href="{{ $contact->messenger ?? 'https://m.me/coralclean' }}" class="cta-btn secondary" target="_blank" style="background: #0084FF;">Messenger →</a>
            </div>
        </div>
    </section>
    ...
    <div class="floating-buttons">
        ...
        <a href="{{ $contact->messenger ?? 'https://m.me/coralclean' }}" target="_blank" class="floating-btn floating-btn--messenger" title="Messenger" aria-label="Messenger">
